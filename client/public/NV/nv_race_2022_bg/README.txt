Nevada 2022 Select Race Data from the American Community Survey (2018-2022) at the Block Group level
...
##Processing
ACS data for Nevada was retrieved with a Python script from the Census API.
The block group data is available by county for all counties in Nevada. The script extracted the data for all counties in Nevada. 
